import { DeliveryCard, Footer, Navbar, NavigationLink, PizzaCard, SectionTitle, SkeletonPizzaCard, Testimonials, ToppingImage } from "../components";
import { useGetPizzas } from "../hooks";
import { Pizza } from "../types";

export const Home = (): JSX.Element => {
  const { loading, response } = useGetPizzas({ page: 1, limit: 10 });
  ...
  return (
    <div className="mx-auto w-full md:w-[768px] lg:w-[1024px] xl:w-[1280px]">
      ...
      <main className="mt-12 mb-32 w-full px-2 xl:px-0 py-12">
